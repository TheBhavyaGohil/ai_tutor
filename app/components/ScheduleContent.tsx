...
export default function ScheduleContent() {
  ...
  // --- API HELPER (Now uses real user email) ---
  ...
  return (
    <div id="timetable-root" className="w-full min-h-screen bg-slate-50 p-4 md:p-12 font-sans text-slate-900">
      <NotificationOverlay
        open={!!notification}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="print:hidden mb-10 text-center">
          ...
          {/* Input Area */}
          <div className="bg-white p-2 rounded-2xl shadow-sm border border-slate-200 flex flex-col md:flex-row gap-2 mb-6">
            <input
          ...
          <div className="flex flex-wrap justify-center gap-3">
             <button onClick={openLoadModal} className="px-4 py-2 bg-white border border-slate-200 hover:border-indigo-500 hover:text-indigo-600 rounded-lg text-sm font-medium flex items-center gap-2 transition-all">
               <DownloadCloud className="w-4 h-4" /> Load Saved
             </button>

             <button onClick={saveAsNew} disabled={schedule.length === 0} className="px-4 py-2 bg-white border border-slate-200 hover:border-indigo-500 hover:text-indigo-600 rounded-lg text-sm font-medium flex items-center gap-2 transition-all disabled:opacity-50">
